...
// 4. แปลง Report 5 แบบพิเศษ (FIXED: เก็บทุกบรรทัด + ตีเส้น + จัดกลาง)
...
function parseDurationToMinutes(durationStr) {
    ...
    // หา pattern เวลา HH:MM:SS หรือ HH:MM
...
// *** FIXED & SMART DATA EXTRACTION (NEW LOGIC) ***
